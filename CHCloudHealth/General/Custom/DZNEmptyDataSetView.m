...
//        _button.backgroundColor = [UIColor clearColor];
        ...
        _button.backgroundColor = [UIColor defaultColor];
...
- (void)setupConstraints
{
    ...
    if (_customView) {
        ...
        CGFloat verticalSpace = self.verticalSpace ? : 25.0; //图片和文字的间距 Default is 25.0 pts
        ...
        if ([self canShowButton]) {
            ...
            [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(80@750)-[button(>=150@200)]-(80@750)-|"
                                                                                     options:0 metrics:metrics views:views]];
        }
        // or removes from its superview
        else {
